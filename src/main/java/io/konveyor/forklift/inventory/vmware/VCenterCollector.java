...
/**
 * {@link VCenterCollector} collects the inventory.
 *
 */
public class VCenterCollector {
    ...
    /**
     * Gets the TraversalSpec.
     *
     * @return the TraversalSpec
     */
    private static TraversalSpec getTraversalSpec() {
        ...
        TraversalSpec folder = new TraversalSpec();
